...
function show() {
    document.getElementById("reportDetailsSpecificTopView").style.display = "block";
    document.getElementById("reportDetailsSpecificBottomView").style.display = "block";
...
function GetViolationsByFleetDetailsSpecific() {
    ...
    var chart = new google.visualization.LineChart(document.getElementById('reportDetailsSpecificTopView'));
    var chart2 = new google.visualization.Table(document.getElementById('reportDetailsSpecificBottomView'));
